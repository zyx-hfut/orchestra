...
class QAAgent(AgentBase):
    ...
    def reply(self, x: Optional[Union[Msg, Sequence[Msg]]] = None):
        ...
        return {'text': response.text, 'text_tmp': ''}
    ...
    def get_msg_clean(self):
        print("\n ===== MESSAGE ===== \n")
        for msg in self.memory.get_memory()[1:-1]:
            print("MSG NAME:", msg.name)
            print(msg.content)
            print("******\n******")
        print("+++++++++++++\n+++++++++++++\n+++++++++++++\n+++++++++++++\n\n\n")
    ...
    def get_reasoning_path(self):
        """Remove few-shot prompt and final answer

        Returns:
            List of messages (conversation history without few-shot and answer)
        """
        # remove few-shot prompt and final answer
        return self.memory.get_memory()[1:-1]
